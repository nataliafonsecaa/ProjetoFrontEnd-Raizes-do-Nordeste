...
const produtosMock = [
    ...
    { id: 7, nome: "Bolo de Rolo", preco: 15.5, unidadeDisponivel: ["Tupã", "Marília"], disponivel: false, sazonal: false, imagem: "img/bolo-de-rolo.jpg" },
    { id: 8, nome: "Sarapatel", preco: 55.0, unidadeDisponivel: ["Tupã", "Marília"], disponivel: true, sazonal: false, imagem: "img/sarapatel.webp" },
    { id: 9, nome: "Buchada de Bode", preco: 65.5, unidadeDisponivel: ["Presidente Prudente", "Tupã", "Marília"], disponivel: true, sazonal: false, imagem: "img/buchada-de-bode.jpg" }
];
...
const loginModalHTML = document.querySelector('#loginModal .modal-content').innerHTML;
...
function exibirPolitica() {
    ...
    `;
    content.innerHTML = politicaHTML;
...
function restaurarModalLogin() {
    const content = document.querySelector('#loginModal .modal-content');
    content.innerHTML = loginModalHTML;
    reativarModal();
}
...
document.getElementById("politicaBannerLink").onclick = (e) => {
    e.preventDefault();
    exibirPolitica();
};
